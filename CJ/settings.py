...
DATABASES = {
    'default': {
        ...
        'HOST': '192.168.43.203',                      # Set to empty string for localhost. Not used with sqlite3.
...
# Changes time zone to Asia/Kolkata
...
SECRET_KEY = '5+@n)+#sy*4#uy=3(ef5xy&amp;kb-tfqouia94zt1yd8dt-v0mmx1'
